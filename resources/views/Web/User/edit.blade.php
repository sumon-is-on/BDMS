                    ...
                    <form action="{{ route('web.profile.update', $user->id) }}" method="POST" class="login-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="Blood group" class="block mb-2 font-medium text-gray-900 dark:text-white">Blood group</label>
                                    <input type="text" name="blood_group" class="form-control rounded-left" value="{{ $user->blood_group }}">
                                </div>
                                <div class="form-group">
