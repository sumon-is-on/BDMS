...
<div class="p-4 md:p-12 text-center lg:text-left">
    <div class="flex justify-center items-center mb-6"> <!-- Added margin-bottom -->
        <img src="{{ asset('/users/' . $donor->image) }}" alt="User Image" class="rounded-full" style="height: 300px; width: 300px;">
    </div>
    <div class="mt-6"> <!-- Added margin-top -->
        <p class="text-8xl font-bold pt-8 lg:pt-0"><b>{{ $donor->name }}</b></p>
    </div>
    <p class="mt-4"><span><b>Blood Group: </b>{{ $donor->blood_group }}</span></p> <!-- Added margin-top -->
    <p class="mt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"> <b>Address:  </b> {{ $donor->address }}</p>
    <p class="mt-2"><span><b>Contact: </b>{{ $donor->phone }}</span></p> <!-- Added margin-top -->
